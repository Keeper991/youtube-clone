...
globalRouter.get(_routes["default"].join, _middlewares.onlyPublic, _userController.join);
globalRouter.post(_routes["default"].join, _middlewares.onlyPublic, _userController.join, _userController.postLogin);
...
globalRouter.get(_routes["default"].github, _middlewares.onlyPublic, _userController.getGithubLogin);
globalRouter.get(_routes["default"].githubCallback, _passport["default"].authenticate("github", {
  failureRedirect: "/login"
}), _userController.postGithubLogin);
globalRouter.get(_routes["default"].facebook, _middlewares.onlyPublic, _userController.getFacebookLogin);
